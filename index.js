...
function maxOfTwoNumbers (a , b) {
  ...
  function findLongestWord(arrarg) {
  
  let longestword= "";
  for (let q = 0; q < arrarg.length; q++){
    if(longestword.length < arrarg[q].length){
      longestword = arrarg[q]
  }
  }
  return longestword 
  }
  ...
  console.log(uniquifyArray(wordsarray))
